...
parser = argparse.ArgumentParser(
    description="""YOLOv10 inference.""",
    formatter_class=argparse.ArgumentDefaultsHelpFormatter
)

parser.add_argument("-m", "--model", required=True, help="relative path to YOLOv10 .pt model")
...
cv2.namedWindow("YOLOv10 Camera",cv2.WINDOW_NORMAL)
cv2.resizeWindow("YOLOv10 Camera", 1600,900)
...
while cap.isOpened():
    ...
    cv2.imshow("YOLOv10 Camera", frame)
