...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="""This script runs YOLOv10 .pt model on local PC.""",
...
# python3 track.py -m yolov10n.pt -s rtsp://172.16.10.255:554/video.pro1 -iou 0.5 -conf 0.4